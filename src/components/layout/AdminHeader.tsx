...
export const AdminHeader = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Actions — fixed top-right, visible only on mobile */}
              ...
              <Button className="gap-1.5 bg-transparent shadow-none border-none hover:bg-transparent focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 p-0 h-auto">
                <div className="flex items-center gap-1.5">
                  <div className="relative">
                    <div className="w-7 h-7 rounded-full ring-2 ring-orange-200/50 dark:ring-orange-500/30 overflow-hidden">
                      <img
                      ...
                      <div className="hidden w-full h-full bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center">
                        <span className="text-white text-[10px] font-semibold">SA</span>
                      </div>
                    </div>
              ...
              <DropdownMenuLabel className="px-2.5 py-2.5">
                <Link to="/profile" className="flex items-center gap-2.5">
                  ...
                  <div className="flex flex-col min-w-0 flex-1">
                    <span className="text-[12px] font-semibold text-gray-900 dark:text-white truncate">Sarah Admin</span>
                    <span className="text-[10px] text-gray-500 dark:text-gray-400 truncate">sarah@jhinxpay.com</span>
